...
function Chatbot() {
  ...
  const handleInput = () => {
    ...
    if (words2.test(document.querySelector("#input").value)) {
      ...
      getBotMessage.innerText = "Typing...";
      setTimeout(() => {
        getBotMessage.innerText = "Hello There how are you doing today?Tell me about your Issue"; // display the message
    ...
    if (words8.test(document.querySelector("#input").value)) {
      getBotMessage.innerText = "Typing...";
      setTimeout(() => {
        getBotMessage.innerText = "My name is Xzone Customer Care";
        inputRef.value = ""; // clear the input
      }, 2000);
    }
    ...
    if (words9.test(document.querySelector("#input").value)) {
      getBotMessage.innerText = "Typing...";
      setTimeout(() => {
        getBotMessage.innerText = "The owner of this is Xzone Shopping Mall";
        inputRef.value = ""; // clear the input
      }, 2000);
    }
      ...
      <div className="wrapper">
        <div className="content">
          <div className="header">
            ...
            <div className="right">
              <div className="name">Xzone Customer Care</div>
